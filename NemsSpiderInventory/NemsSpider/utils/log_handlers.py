...
class SafeFileHandler(logging.FileHandler):
    ...
    def build_baseFilename(self):
        ...
        self.baseFilename = self.baseFilename + "." + self.suffix_time + ".log"  # +.log   add by yang
...
# class BaseRotatingHandler(logging.FileHandler): ###change by yang
